...
public class UserDAO implements IUserDAO{
    ...
    private static final String SELECT_USERS_BY_COUNTRY_ORDER_BY_NAME = "select id,name,email,country from users where country =? order by name";
    ...
    @Override
    public List<User> selectbyCountry(String search) {
    ...
    public List<User> orderSelectedList(String search) {
        ...
        try (
            Connection connection = getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SELECT_USERS_BY_COUNTRY_ORDER_BY_NAME);){
                preparedStatement.setString(1,search);
                System.out.println(preparedStatement);
                ResultSet resultSet = preparedStatement.executeQuery();
                while (resultSet.next()) {
